...
class BaseModel(nn.Module):
    ...
    def __init__(
        ...
        actor_features_extractor: Optional[BaseFeaturesExtractor] = None,
        ...
        self.actor_features_extractor = actor_features_extractor
        ...
        if not normalize_images and issubclass(actor_features_extractor_class, (NatureCNN, CombinedExtractor)):
            self.actor_features_extractor_kwargs.update(dict(normalized_image=True))
            self.critic_features_extractor_kwargs.update(dict(normalized_image=True))
    ...
    def _update_actor_features_extractor(
        self,
        net_kwargs: Dict[str, Any],
        features_extractor: Optional[BaseFeaturesExtractor] = None,
    ) -> Dict[str, Any]:
        ...
        if features_extractor is None:
            # The features extractor is not shared, create a new one
            features_extractor = self.make_actor_features_extractor()
        net_kwargs.update(dict(features_extractor=features_extractor, features_dim=features_extractor.features_dim))
        return net_kwargs

    def _update_critic_features_extractor(
        self,
        net_kwargs: Dict[str, Any],
        features_extractor: Optional[BaseFeaturesExtractor] = None,
    ) -> Dict[str, Any]:
        ...
        if features_extractor is None:
            # The features extractor is not shared, create a new one
            features_extractor = self.make_critic_features_extractor()
        net_kwargs.update(dict(features_extractor=features_extractor, features_dim=features_extractor.features_dim))
        return net_kwargs

    def make_features_extractor(self) -> BaseFeaturesExtractor:
        """Helper method to create a features extractor."""
        return self.features_extractor_class(self.observation_space, **self.actor_features_extractor_kwargs)

    def make_actor_features_extractor(self) -> BaseFeaturesExtractor:
        """Helper method to create a features extractor."""
        return self.actor_features_extractor_class(self.observation_space, **self.actor_features_extractor_kwargs)

    def make_critic_features_extractor(self) -> BaseFeaturesExtractor:
        """Helper method to create a features extractor."""
        return self.critic_features_extractor_class(self.observation_space, **self.critic_features_extractor_kwargs)
...
class ActorCriticPolicy(BasePolicy):
    ...
    def __init__(
        ...
        self.actor_features_extractor = self.make_actor_features_extractor()
        self.critic_features_extractor = self.make_critic_features_extractor()
    ...
    def _get_constructor_parameters(self) -> Dict[str, Any]:
        ...
        data.update(
            dict(
                ...
                actor_features_extractor_class=self.actor_features_extractor_class,
                critic_features_extractor_class=self.critic_features_extractor_class,
                actor_features_extractor_kwargs=self.actor_features_extractor_kwargs,
...
class ActorCriticCnnPolicy(ActorCriticPolicy):
    ...
    def __init__(
        ...
        use_expln: bool = False,
        squash_output: bool = False,
        actor_features_extractor_class: Type[BaseFeaturesExtractor] = NatureCNN,
        critic_features_extractor_class: Type[BaseFeaturesExtractor] = NatureCNN,
        actor_features_extractor_kwargs: Optional[Dict[str, Any]] = None,
        critic_features_extractor_kwargs: Optional[Dict[str, Any]] = None,
        share_features_extractor: bool = True,
        normalize_images: bool = True,
...
class ContinuousCritic(BaseModel):
    ...
    def __init__(
        ...
        super().__init__(
            observation_space,
            action_space,
            critic_features_extractor=features_extractor,
            normalize_images=normalize_images,
        )
    ...
    def forward(self, obs: th.Tensor, actions: th.Tensor) -> Tuple[th.Tensor, ...]:
        ...
        with th.set_grad_enabled(not self.share_features_extractor):
            features = self.extract_features(obs, self.critic_features_extractor)
